...
Im diesem Bios sind 2 Laufwerke (A,B) im NDR Format (80TRK, 5 x 1024, 800KB) und 2 Laufwerke (C,D) im 8"  im IBM Format definiert. 3,5" Laufwerke verhalten sich wie 8" Laufwerke. Eine 3,5" Diskette mit offenen HD Loch kann als IBM Diskette formatiert werden. 
